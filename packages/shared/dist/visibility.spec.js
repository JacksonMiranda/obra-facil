...
(0, vitest_1.describe)('computeCompleteness', () => {
    ...
    (0, vitest_1.it)('returns missing=["services"] when activeServiceCount is 0', () => {
        const result = (0, visibility_1.computeCompleteness)({
        ...
        (0, vitest_1.expect)(result.missing).toContain('services');
    });
    (0, vitest_1.it)('returns missing=["services"] when activeServiceCount is undefined', () => {
        const result = (0, visibility_1.computeCompleteness)({
            bio: 'Profissional experiente com vasta experiência',
            full_name: 'João Silva',
        });
...
(0, vitest_1.describe)('isProfessionalPubliclyVisible', () => {
    ...
    (0, vitest_1.it)('returns false when activeServiceCount is 0', () => {
        (0, vitest_1.expect)((0, visibility_1.isProfessionalPubliclyVisible)({ ...completeActive, activeServiceCount: 0 })).toBe(false);
    });
